...
DEALER_MAP.dealer_locator = function(dealer, i){
	...
	var str = "<div class='__info'><div class='__info-header' >"
		+ i + "." + "<span>" + dealer.name + "</span>"
		+ "<span class='__info-header-second'>(with in "
        + distance +"miles of you)</span></div>"
		+ "<div class='__info-body'>" + dealer.address + " | " + dealer.phone + " | "
		+ "<a href='" + dealer.website + "'>" + dealer.website + "</a>"
		+ "<div class='__info-body-second' id='__info-select" + i + "'>"
		+ "<span class='__info-body-second-tag'>|</span>"
		+ "<a href='#'><img src='./dealer-locator/images/select.png'>&nbsp;"
		+ "<span class='__info-body-second-tag2'>View on map</span></a></div></div></div>";
